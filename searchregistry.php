	...
	<body>
		...
		<div class="text-center">
			...
			<form name="updateform" id="updateform" class="card form-registry" method="post" action="" style="display: none;">
				...
				<button class="btn btn-lg btn-primary btn-block" type="submit" id="getProducts" name="getProducts"><a>Show Products</a></button>
			...
			<script type="text/javascript">
				$(document).ready(function(){
					...
					$("#getProducts").click(function(e) {
						e.preventDefault();
						$(this).prop('disabled', true);
						var reg = document.getElementById("newregistrycode").value;
